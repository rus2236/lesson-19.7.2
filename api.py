...
class PetFriends:
    ...
    def add_new_pet(self, auth_key: json, name: str, animal_type: str, age: str, pet_photo: str) -> json:
        ...
        data = MultipartEncoder(
            fields={
                ...
                'age': age,
                'pet_photo': (pet_photo, open(pet_photo, 'rb'), 'images/dog1.jpg')
            })
    ...
    def add_photo_of_pet(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        """Метод отправляет (постит) на сервер данные и добавляет фото указанного pet_id питомца и возвращает статус
            запроса на сервер и результат в формате JSON с данными добавленного питомца"""
